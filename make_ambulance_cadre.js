...
let content = fs.readFileSync('ambulance.svg', 'utf8');
...
fs.writeFileSync('ambulance_cadre.svg', content);
console.log('ambulance_cadre.svg created with pure black frame');
