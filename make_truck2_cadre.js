...
let content = fs.readFileSync('truck2.svg', 'utf8');
...
// Since the whole graphic is inside matching <g> and </svg> tags
content = content.replace(/<\/svg>/i, '</g>\n</svg>');

fs.writeFileSync('truck2_cadre.svg', content);
console.log('truck2_cadre.svg created with enhanced pure black frame');
